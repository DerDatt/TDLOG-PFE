...
import pandas as pd
from backend.appPFE.utils import strip_name_of_underscores_begin_end
...
def generate_model_fields_from_csv(csv_path="backend/appPFE/field_data.csv", output_path="generated_fields.txt"):
    """
...
if __name__ == "__main__":
    generate_model_fields_from_csv(
        csv_path="backend/appPFE/field_data.csv",
