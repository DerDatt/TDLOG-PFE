...
(Se référer à la liste fournie par le Département)} & __Thematique_principale__ \\ \hline
 ...
 & __Presentation_contexte_FR__ \\ \hline
    ...
    \textbf{Bibliographie}\newline\begin{itemize} \item Référence 1 (otpionnel) : \item Référence 2 (otpionnel) : \item Référence 3 (otpionnel) : \end{itemize} &\begin{itemize} \item __Bibliographie1__  \item __Bibliographie2__  \item __Bibliographie3__ \end{itemize}  \\ \hline
