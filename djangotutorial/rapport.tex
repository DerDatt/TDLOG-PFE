...
\hline
    ...
    \textbf{Prénom NOM} & Sdkas Fgh \\ \hline
    ...
    \textbf{Promotion (indiquez l'année)} & 27 \\ \hline
...
(Se référer à la liste fournie par le Département)} & Transport \\ \hline
    \textbf{Mots-clés en français (3 à 5) (séparés par des ; sans majuscule)} & Clef \\ \hline
 ...
 & context franc \\ \hline
    ...
    \textbf{Résumé en français du PFE (version non confidentielle)} Longueur conseillée entre 1150 et 1700 signes, espaces compris & reumeeee \\ \hline
    \textbf{Titre du PFE en anglais} (Entre 10 et 75 signes espaces compris) & title \\ \hline
    \textbf{Mots-clés en anglais (3 à 5)} & clefs \\ \hline
    \textbf{Présentation du contexte du PFE en anglais (version non confidentielle)} Longueur conseillée : entre 200 et 450 signes, espaces compris & context engl \\ \hline
    ...
    \textbf{Résumé du PFE en anglais (version non confidentielle)}\newline\newline Longueur conseillée entre 1150 et 1700 signes, espaces compris & resume \\ \hline
...
\noindent $\Box$~Je confirme et autorise la diffusion.\\[0.25cm]

\noindent $\Box$~Je certifie sur l'honneur l'exactitude des informations.
