...
\hline
    \textbf{Département d'enseignement} & IMI \\ \hline
    \textbf{Prénom NOM} & Vincent CANNIZZARO \\ \hline
    ...
    \textbf{Votre photo portrait (minimum 295 pixels de large, sous format jpeg ou png)} & \center\includegraphics[width=4cm]{C:/Users/jakob/Documents/FAU/AuslandsSemester/TDLOG/projet/TDLOG-PFE/backend/media/images/newaccount_11_picture.png} \\ \hline
...
(Se référer à la liste fournie par le Département)} & Transport \\ \hline
 ...
 & 13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères13 caractères \\ \hline
    ...
    \textbf{Résumé en français du PFE (version non confidentielle)} Longueur conseillée entre 1150 et 1700 signes, espaces compris & La plasticité cellulaire désigne la capacité des cellules à modifier leur état fonctionnel, leur identité ou leur comportement en réponse à des signaux internes ou externes. Longtemps considérée comme limitée aux cellules souches, cette propriété est aujourd’hui reconnue dans de nombreux tissus différenciés. Elle repose sur des mécanismes moléculaires complexes impliquant la régulation épigénétique, la signalisation intracellulaire et les interactions avec le microenvironnement.  Au niveau moléculaire, la plasticité cellulaire est étroitement liée aux modifications de la chromatine, telles que la méthylation de l’ADN ou les modifications post-traductionnelles des histones, qui permettent une reprogrammation partielle ou totale de l’expression génique. Ces changements peuvent être transitoires ou stables, selon le contexte physiologique ou pathologique. Par exemple, lors de la régénération tissulaire, certaines cellules différenciées peuvent acquérir des caractéristiques progénitrices afin de remplacer des cellules perdues.  Cependant, cette plasticité présente une double face. Si elle est essentielle au développement, à l’homéostasie et à la réparation des tissus, elle peut également contribuer à des processus pathologiques. En cancérologie, la plasticité cellulaire favorise l’hétérogénéité tumorale, la résistance aux traitements et la capacité métastatique des cellules cancéreuses. Comprendre les mécanismes qui contrôlent cette plasticité constitue donc un enjeu majeur pour le développement de nouvelles stratégies thérapeutiques ciblées. \\ \hline
    ...
    \textbf{Présentation des missions et objectifs du PFE en anglais (version non confidentielle)} Longueur conseillée : entre 200 et 450 signes, espaces compris & 1 \\ \hline
    \textbf{Résumé du PFE en anglais (version non confidentielle)}\newline\newline Longueur conseillée entre 1150 et 1700 signes, espaces compris & Cellular plasticity refers to the capacity of cells to alter their functional state, identity, or behavior in response to internal or external signals. Long regarded as limited to stem cells, this property is now acknowledged in numerous differentiated tissues. It is based on complex molecular mechanisms involving epigenetic regulation, intracellular signaling, and interactions with the microenvironment. At the molecular level, cellular plasticity is closely linked to chromatin modifications, such as DNA methylation or post-translational modifications of histones, which permit partial or total reprogramming of gene expression. These changes can be transient or stable, depending on the physiological or pathological context. For instance, during tissue regeneration, certain differentiated cells may acquire progenitor-like characteristics to replace lost cells. However, this plasticity has a dual face. While it is essential for development, homeostasis, and tissue repair, it can also contribute to pathological processes. In oncology, cellular plasticity promotes tumor heterogeneity, treatment resistance, and the metastatic potential of cancer cells. Therefore, understanding the mechanisms that control this plasticity constitutes a major challenge for the development of new targeted therapeutic strategies. \\ \hline
